...
@register_agent("matthieu_agent")
class MatthieuAgent(Agent):
  """
  ...
  def __init__(self):
    super(MatthieuAgent, self).__init__()
    self.name = "MatthieuAgent"
  ...
  def step(self, chess_board, player, opponent):
    ...
    print("Matthieu's turn took ", time_taken, "seconds.")
